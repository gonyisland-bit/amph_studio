        ...
        return (
          ...
          >
            <div className={`flex-1 p-6 sm:p-8 md:p-16 lg:p-24 flex flex-col justify-center ${i % 2 === 0 ? "md:border-r" : "md:order-last md:border-l"} border-black/10`}>
              <span className="text-[10px] uppercase tracking-widest font-bold text-cobalt font-sans block mb-3 md:mb-6">Space 0{i + 1}</span>
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-medium tracking-tighter uppercase font-sans mb-4 md:mb-8 leading-[0.95] md:leading-[0.9] group-hover:text-cobalt transition-colors">{space.title}</h2>
